...
class WithdrawOtherInterface():
    ...
    def __init__(self, master: Frame):
        ...
        self.top_label = Label(self.top_frame, text="Please enter withdrawal amount", font=("Courier", 20))
        self.middle_amount_box = Entry(self.middle_frame, font=("Courier", 35), justify=CENTER)
        ...
        self.middle_amount_box.grid(row=0, column=0, sticky=NSEW, padx=20, pady=20)
